...
OUT=/home/PC/SERE_v1/results/frontier
LOGS=$OUT/logs
mkdir -p "$OUT" "$LOGS"
...
round 1 0    0.2  0.25   # isolate the cost of the per-token rescue
round 2 0    0.35 0.25   # more budget, same floor (floor may bind)
round 3 0    0.5  0.10   # floor lowered so the budget can actually bite
round 4 0    0.7  0.10   # near-maximal pruning
