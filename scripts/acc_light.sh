...
cell cm_f005     0,1 8900 contrib_mass 0.05 0.25 0 50 90 &
cell cm_f010     2,3 8901 contrib_mass 0.10 0.25 0 50 90 &
wait
bash "$AR/scripts/drain_gpus.sh" >/dev/null 2>&1
cell cm_f015     0,1 8900 contrib_mass 0.15 0.25 0 50 90 &
cell base_light  2,3 8901 base         0.2 0.25 0 50 90 &
wait
echo "=== DONE $(date '+%F %T') ==="
